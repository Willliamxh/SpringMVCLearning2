...
public class MyController {
     ...
     * 返回对象框架的处理流程：
     *  1. 框架会把返回Student类型，调用框架的中集合ArrayList<HttpMessageConverter>中每个类（一共8个类）的canWrite()方法
     *     检查那个HttpMessageConverter接口的实现类能处理Student类型的数据--（最终找到这个为真）MappingJackson2HttpMessageConverter
     *
